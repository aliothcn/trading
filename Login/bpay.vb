Public Class bpay
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        ta = bll.getbysid(t.Rows(ComboBox1.SelectedIndex).Item(0))
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        If e.RowIndex > -1 Then
            ...
            Dim s As New Trading.Model.Buy
            s.id = ta.Rows(e.RowIndex).Item("内部编号")
            s.sid = t.Rows(ComboBox1.SelectedIndex).Item(0)
    ...
    Private Sub bpay_Load(sender As Object, e As EventArgs) Handles MyBase.Load
