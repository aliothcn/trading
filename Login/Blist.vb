Public Class Blist
    Dim t As New DataTable("blist")
    Dim t_sup As New DataTable("sup")
    Dim oked As Boolean = False
    ...
    Private Sub isok()
        ...
        TextBox1.Text = heji
    End Sub
    Private Sub Blist_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        End If
        If oked = False Then
            MsgBox("请先点击检查输入按钮",, "系统提示")
            Exit Sub
        End If
        If t.Rows.Count > 0 Then
            Dim b As New Trading.Model.Buy
            b.sid = t_sup.Rows(ComboBox1.SelectedIndex).Item(0)
            b.sday = DateTimePicker1.Text
            b.money = Val(TextBox1.Text.Trim)
            b.ispay = CheckBox1.Checked
            b.text = TextBox3.Text.Trim
            Dim bb As New Trading.BLL.buyBLL
            Dim temp As Integer
            temp = bb.insert(b)
            If temp > 0 Then
                For i = 0 To t.Rows.Count - 1
                    ...
                    bl.unit = t.Rows(i).Item("单位").ToString
                    bl.text = t.Rows(i).Item("备注").ToString
                    Dim blist_bll As New Trading.BLL.BlistBLL
